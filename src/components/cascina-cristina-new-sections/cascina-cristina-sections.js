...
const sections = [
      ...
      <Template
        ...
        description={
          <>
            ...
            loro figli, i genitori dell&#39;associazione hanno deciso di
            mettersi al servizio del territorio per rendere meno difficile il
            percorso delle famiglie che si verranno a trovare in una situazione
            analoga a quella da loro vissuta. Da qui la sfida di creare un polo
            multifunzionale per l&#39;autismo. Un centro in grado di accogliere
            in forma residenziale adulti autistici a basso funzionamento, di
            offrire la possibilità di abilitazione a giovani autistici per i
            quali è sufficiente una gestione diurna, di dare sollievo temporaneo
            a quelle famiglie che attraversano un periodo complicato con il loro
            figlio autistico. Il polo Cascina Cristina si occuperà anche di
            formazione degli operatori del settore e cercherà di agevolare il
            percorso di diagnosi della potenziale persona autistica. Una volta
            accreditata, la struttura, lavorando in rete con le istituzioni
            sanitarie, organizzerà una presa in carico coordinata della persona
            autistica.
          </>
        }
      />
      ...
      <Template
        ...
        description={
          <>
            ...
            disabilità che, da una gestione pressoché tutta assistenzialistica,
            sta passando a considerare la disabilità come parte integrante della
            persona e, quindi, all’applicazione di metodologie
            abilitative/psicoeducative, conferendogli dignità e pari
            opportunità, nei limiti delle sue capacità potenziali. La spinta a
            questa nuova visione è da attribuire a diverse cause: la situazione
            economica del Paese e delle Regioni, le scoperte scientifiche, il
            nuovo welfare, la partecipazione sempre più attiva della famiglia
            nel ripensare gli interventi sul proprio figlio. Anche Abilitiamo
            con il progetto “Cascina Cristina” partecipa al cambiamento,
            applicando, quanto più possibile, tutte le nuove tecniche e/o
            metodiche che sono emerse dagli studi scientifici più recenti e la
            conoscenza più specifica e approfondita dei vari professionisti del
            settore. In particolare, seguendo le linee di un progetto
            sperimentale, Abilitiamo intende dare uniformità e continuità
            all’utilizzo delle nuove tecniche proposte dalla letteratura,
            attualmente puntiformi e prive di connessioni, individuando i
            parametri che meglio si adattano al potenziamento delle abilità
            della persona con autismo nei vari contesti di vita, rendendola il
            più possibile regista e attore della propria vita.
          </>
        }
      />
    ),
      ...
      <Template
        ...
        description={
          <>
            ...
            analoghe esperienze estere e italiane. Cascina Cristina è collocata
            in un contesto rurale e ciò favorirà l&#39;abilitazione fondata sul
            ...
            collocata in un contesto rurale, è allo stesso tempo integrata con
            il territorio urbano di Fecchio (località di Cantù), trovandosi di
            fronte alla Parrocchia di San Carlo e all’annesso oratorio. Ciò
            eviterà l’isolamento e favorirà la relazione delle persone
            autistiche con gli abitanti del luogo. La residenza sarà costituita
            da 6 camere da letto, ciascuna in grado di ospitare 2 letti, e da
            tanti servizi visibili nelle piantine dell’edificio raffigurate
            nell’immagine.
          </>
        }
      />
  ...
  },
  {
    ...
    content: (
      <Template
        ...
        description={
          <>
            Il centro diurno è un servizio sociale, semiresidenziale e
            territoriale rivolto a giovani adulti con autismo che vivono ancora
            in famiglia. Il progetto prevede, dopo una attenta valutazione
            individuale delle proprie competenze, la messa a punto di un piano
            di intervento personalizzato che consenta ai fruitori, come per chi
            vive nella comunità residenziale, di ottimizzare e/o sviluppare
            tutte quelle abilità necessarie a migliorare tutte le autonomie
            spendibili nel proprio contesto di vita oltre che la loro autostima
            ed autodeterminazione. Il centro potrà accogliere fino a 15 persone,
            che si affiancheranno agli ospiti già presenti in struttura nella
            gestione della quotidianità. L’obiettivo è innalzare quanto più
  ...
  },
  {
    ...
    content: (
      <Template
        title="Sollievo e altri servizi"
        subtitle={
          <>
        ...
        description={
          <>
            ...
            gestire la quotidianità e spesso mandano le famiglie in{" "}
            <i>burn-out</i>. Cascina Cristina disporrà di due posti per ospitare
            temporaneamente persone che attraversano queste crisi, in modo da
            dare il tempo alle famiglie di riprendersi e valutare il tipo di
            intervento sociosanitario e/o riabilitativo-abilitativo da
            effettuare sul proprio figlio con autismo.
          </>
        }
      />
    ),
      ...
      <Template
        ...
        description={
          <>
            ...
            possibile e, nel contempo, lavorino tutti con la medesima modalità,
            a partire in primis dalla famiglia la quale deve far fronte
            continuamente e costantemente a richieste dirette e indirette, anche
            pesanti, del proprio figlio e/o delle persone che lo circondano. Il
            sostegno alla famiglia diventa quindi parte integrante del progetto
            ...
            psicologico, per interventi individuali se richiesti, sia mediante
            la costituzione di un gruppo di auto mutuo aiuto autogestito e,
            quando necessario e/o richiesto potrà essere guidato dai diversi
            professionisti presenti in Cascina.
          </>
        }
      />
    ),
  },
  {
    ...
    content: (
      <Template
        title="Comprendere la sindrome autistica"
        subtitle={
          <>
