...
export default function CascinaCristina() {
	...
	const spirito = (
		<>
			...
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setSpiritoMostraAltro(!spiritoMostraAltro)}>
					{spiritoMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, spiritoMostraAltro ? "force-display-inline" : ""].join(" ")}>
	...
	const mappa = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image2.childImageSharp.fluid} />
			<div className={[stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setMappaMostraAltro(!mappaMostraAltro)}>
					{mappaMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, mappaMostraAltro ? "force-display-inline" : ""].join(" ")}>
	...
	const cambiamento = (
		<>
			<div className={stylesCascinaCristina.sectionTitle}>
				...
				<p className="paragraph">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin</p>
			</div>
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image1.childImageSharp.fluid} />
			<div className={[stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setCambiamentoMostraAltro(!cambiamentoMostraAltro)}>
					{cambiamentoMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, cambiamentoMostraAltro ? "force-display-inline" : ""].join(" ")}>
					...
					cover it and seemed ready to slide off any moment. His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he
	...
	const comunita = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image4.childImageSharp.fluid} />
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setComunitàMostraAltro(!comunitàMostraAltro)}>
					{comunitàMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, comunitàMostraAltro ? "force-display-inline" : ""].join(" ")}>
	...
	const diurno = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image5.childImageSharp.fluid} />
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setDiurnoMostraAltro(!diurnoMostraAltro)}>
					{diurnoMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, diurnoMostraAltro ? "force-display-inline" : ""].join(" ")}>
	...
	const sollievo = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image1.childImageSharp.fluid} />
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setSollievoMostraAltro(!sollievoMostraAltro)}>
					{sollievoMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, sollievoMostraAltro ? "force-display-inline" : ""].join(" ")}>
	...
	const presa = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image1.childImageSharp.fluid} />
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setPresaMostraAltro(!presaMostraAltro)}>
					{presaMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, presaMostraAltro ? "force-display-inline" : ""].join(" ")}>
					...
					it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.
				</span>
			</p>
		</>
	)
	const emblematicità = (
		<>
			...
			<Img className={["round-borders", stylesCascinaCristina.imgSectionCover].join(" ")} fluid={images.image1.childImageSharp.fluid} />
			<p className={["paragraph", stylesCascinaCristina.paragraph, stylesCascinaCristina.columns].join(" ")}>
				<button className={stylesCascinaCristina.mostraAltro} onClick={() => setEmblematicitàMostraAltro(!emblematicitàMostraAltro)}>
					{emblematicitàMostraAltro ? "Nascondi" : "Mostra altro"}
				</button>
				<span className={[stylesCascinaCristina.further, emblematicitàMostraAltro ? "force-display-inline" : ""].join(" ")}>
					Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove
					right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia.
					It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts
					it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.
...
export const query = graphql`
	query {
		...
		image5: file(relativePath: { eq: "render residenziale.jpeg" }) {
			childImageSharp {
				fluid {
					...GatsbyImageSharpFluid
				}
