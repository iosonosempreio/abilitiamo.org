        ...
        <Row className="">
          <Col xs={12} md={{ span: 7, offset: 1 }}>
            <section className={classNames("mt-3", "mt-md-5")}>
              ...
              <p className="paragraphBig">
                ...
                <br />
                Daremo vita a un importante progetto di accoglienza, sviluppo e
                condivisione per tenere unita la nostra comunità.
              </p>
              ...
              <p>
                ...
                Fecchio unita al supporto di Fondazione Cariplo e Regione Lombardia,
                sarà riqualificata e restituita alla cittadinanza.
              </p>
              <p>
            ...
            >
              ...
              <p>
                È anche possibile devolvere ad Abilítiamo il patrimonio di altre
                associazioni ONLUS in fase di scioglimento.
              </p>
            </section>
          </Col>
          <Col
          ...
          >
            <div className={classNames("position-sticky")} style={{ top: 104 }}>
              <p className="mb-1" style={{ color: "#999" }}>
                Tutte le modalità
              </p>
              <ArrowLink
                data={{
