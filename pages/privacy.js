					...
					<Row className="my-5">
						<Col md={{ span: 7, offset: 1 }}>
							...
							<p>
								...
								di protezione e trattamento dei dati personali. Abilitiamo
								Autismo ONLUS ha provveduto ad adeguare ed aggiornare la
								relativa normativa e l’informativa ai soci in conformità con
							...
							<p>
								...
								dell’utilizzo dei vostri dati personali da parte di Abilitiamo
								Autismo ONLUS e dei vostri diritti ai sensi del Regolamento
								Generale sulla Protezione dei dati personali – Regolamento (UE)
							...
							<ol>
								<li>
									...
									<p>
										Il Titolare del Trattamento è l’associazione Abilitiamo
										Autismo ONLUS con sede legale presso Carugo CO Via per
										Gattedo 19/7. Il Responsabile della protezione dei dati,
										pertanto, può essere contattato presso: Abilitiamo Autismo
										Onlus Carugo CO Via per Gattedo 19/7 email:
										info@abilitiamo.org
									</p>
								</li>
								<li>
									...
									<p>
										Abilitiamo Autismo onlus tratta i suoi dati personali per le
										seguenti finalità:
										<ul>
											<li>
												...
												Abilitiamo Autismo ONLUS non disponesse dei predetti
												dati personali, si troverebbe nell’impossibilita di
												adempiere a quanto previsto dalla normativa.
											</li>
											<li>
												B. Necessità di adempiere ad obblighi derivanti dalla
												adesione a Abilitiamo Autismo ONLUS, strettamente
												connessi e strumentali alla adesione medesima. Tale
												necessità rappresenta la base giuridica che legittima i
												relativi trattamenti. Il conferimento dei dati è
												necessario per la gestione del rapporto con Abilitiamo
												Autismo onlus che, in mancanza dei predetti dati
												personali sarebbe nell’impossibilità di instaurare il
								...
								<li>
									...
									<p>
										Abilitiamo Autismo ONLUS tratta i dati personali raccolti
										direttamente presso di Lei, ovvero presso terzi, che
										includono, a titolo esemplificativo, dati anagrafici (es.
										nome, cognome, n telefono indirizzo, data e luogo di
								...
								<li>
									...
									<p>
										...
										dati che La riguardano in possesso di Abilitiamo Autismo
										ONLUS, nonché come vengono utilizzati e di ottenere, quando
										ne ricorrano i presupposti, la copia, la cancellazione
										nonché l’aggiornamento, la rettificazione o, se vi è
										interesse, l’integrazione dei dati nonché il diritto alla
										portabilità.
									</p>
								</li>
								<li>
									...
									<p>
										Abilitiamo Autismo ONLUS tratta e conserva i Suoi dati
										personali per tutta la durata dell’adesione, per
								...
								<li>
									...
									<p>
										...
										possesso di Abilitiamo Autismo ONLUS in un formato
								...
								<li>
									...
									<p>
										...
										potrà scrivere ad Abilitiamo Autismo ONLUS e-mail:
										info@abilitiamo.org
										<br />
										Il termine per la risposta è un (1) mese, prorogabile di due
										(2) mesi in casi di particolare complessità; in questi casi,
										Abilitiamo Autismo ONLUS fornisce almeno una comunicazione
										interlocutoria entro un (1) mese.
										<br />
										L’esercizio dei diritti è, in linea di principio, gratuito;
										Abilitiamo Autismo ONLUS si riserva il diritto di chiedere
										un contributo in caso di richieste manifestamente infondate
										o eccessive (anche ripetitive).
										<br />
										Abilitiamo Autismo ONLUS ha il diritto di chiedere
								...
								<li>
									...
									<p>
										Abilitiamo Autismo ONLUS La informa che Lei ha diritto di
										proporre reclamo ovvero effettuare una segnalazione al
										Garante per la Protezione dei Dati Personali oppure in
										alternativa presentare ricorso all’Autorità Giudiziaria. I
